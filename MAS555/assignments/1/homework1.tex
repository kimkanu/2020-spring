...
\newcommand{\paren}[2][]{\wrapwithdelimiter{#1}{#2}()}
\newcommand{\set}[2][]{\wrapwithdelimiter{#1}{#2}\{\}}
\newcommand{\bracket}[2][]{\wrapwithdelimiter{#1}{#2}[]}
